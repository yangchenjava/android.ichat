...
public abstract class FlexibleDividerDecoration extends RecyclerView.ItemDecoration {
	...
	protected List<Integer> mPositionWithoutDivider;
	...
	protected FlexibleDividerDecoration(Builder<?> builder) {
		...
		mPositionWithoutDivider = builder.mPositionWithoutDivider;
	}
	...
	public static class Builder<T extends Builder<?>> {
		...
		private List<Integer> mPositionWithoutDivider;
		...
		public T positionWithoutDivider(List<Integer> positionWithoutDivider) {
			mPositionWithoutDivider = positionWithoutDivider;
			return (T) this;
		}
