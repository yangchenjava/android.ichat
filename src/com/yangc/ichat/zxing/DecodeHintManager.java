...
public final class DecodeHintManager {
	 ...
	 * 
	 * <p>
	 * This method ignores multiple parameters with the same name and returns the first one only. This is technically incorrect, but should be acceptable due to the method of processing Hints: no
	 * multiple values for a hint.
	 * </p>
	 * 
