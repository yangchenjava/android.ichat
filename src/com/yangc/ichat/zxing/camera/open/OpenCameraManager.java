...
package com.yangc.ichat.zxing.camera.open;
...
public final class OpenCameraManager extends PlatformSupportManager<OpenCameraInterface> {
	...
	public OpenCameraManager() {
		...
		addImplementationClass(Build.VERSION_CODES.GINGERBREAD, "com.yangc.ichat.zxing.camera.open.GingerbreadOpenCameraInterface");
	}
